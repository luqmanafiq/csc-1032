 ...
 * 
 * Return values:
 * If the value x is in the array, the function returns its index position.
 * If it is not found, the function returns -1. 
 * If arr is NULL or n is less than 0, the function returns -1 and the 
...
/* 
 * rlinearsearch - a recursive implementation of a function to perform a 
 * linear search of an int array for a given value. See the README.txt file
 * for a description of linear search (in the Further Information section).
 * The function  returns the index position of the value if it is found, 
 * and -1 if it is not found.
 ...
 * Usage:
 *      int arr[] = { 1, 0, 4, 3, 6};
 *      int idx = rlinearsearch(4, arr, 5, 0);  // search for 4 in array 
 *                                              // arr of length 5 starting 
 *                                              // at index position 0. 
 ...
 * arr - the array to search
 * n - the length of the array (number of items in the array)
 * i - the current index position for each recursive step
 ...
 * README.txt file for a description of sentinal linear search (in the 
 ...
 * Usage:
 *      int arr[] = { 1, 0, 4, 3, 6};
 *      int idx = slinearsearch(4, arr, 5); // search for 4 in array arr 
 *                                          // of length 5. idx will be 2 
 *                                          // in this example.
 * 
 * Parameters:
 * x - the value to search for
...
/* 
 * rbinarysearch - a recursive implementation of a function to perform a 
 * binary search of an ordered int array for a given value. See the 
 * README.txt file for a description of binary search (in the Further
 * Information section).
 * The function returns the index position of the value if it is found, 
